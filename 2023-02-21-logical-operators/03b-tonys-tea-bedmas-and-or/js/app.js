...
//   if (hasTea) {
//     if (hasSugar) {
//       console.log('Tony makes his tea just before class.');
//     } else {
...
// This code is dry with no nested if statements

// if (hasMilk && hasTea && hasSugar) {
//   console.log('Tony makes his tea just before class.');
// } else {
//   console.log('Tony cancels class and goes to the store.');
// }
...
if ((hasMilk || hasPowderedMilk) && hasTea && hasSugar) {
  console.log('Tony makes his tea just before class.');
} else {
  console.log('Tony cancels class and goes to the store.');
}